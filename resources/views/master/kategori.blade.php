    ...
    <header class="blue accent-3 relative nav-sticky">
        <div class="container-fluid text-white">
            <div class="row">
                <div class="col">
                    <h3 class="my-2">
                        <i class="icon icon-work"></i> Data Kategori
                    </h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-row form-inline">
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                <label for="n_kategori" class="col-form-label s-12 col-md-4">Nama Kategori</label>
                                <input type="text" name="n_kategori" id="n_kategori" placeholder=""
...
<script type="text/javascript">
    ...
    table.on('draw.dt', function () {
        var PageInfo = $('#opd-table').DataTable().page.info();
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#id').val(data.id);
                $('#n_kategori').val(data.n_kategori);
            },
            error : function() {
    ...
    $('#form').on('submit', function (e) {
        if ($(this)[0].checkValidity() === false) {
            ...
            if (save_method == 'add'){
                ...
                url = "{{ route('kategori.update', ':id') }}".replace(':id', $('#id').val());
            }
            $.ajax({
                url : url,
                type : 'POST',
