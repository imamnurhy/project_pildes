    ...
    <header class="blue accent-3 relative nav-sticky">
        <div class="container-fluid text-white">
            <div class="row">
                <div class="col">
                    <h3 class="my-2">
                        <i class="icon icon-chess"></i> Data Golongan
                    </h3>
                </div>
            </div>
        </div>
                ...
                <div class="card no-b">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="golongan-table" class="table table-striped" style="width:100%">
                                <thead>
                                    <th width="30">No</th>
                    ...
                    <div class="form-row form-inline">
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                <label for="n_golongan" class="col-form-label s-12 col-md-4">Nama</label>
                                <input type="text" name="n_golongan" id="n_golongan" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                            </div>
                            <div class="form-group m-0">
...
<script type="text/javascript">
    ...
    var table = $('#golongan-table').dataTable({
        ...
        columns: [
            ...
            {data: 'n_golongan', name: 'n_golongan'},
            {data: 'ket', name: 'ket'},
    ...
    table.on('draw.dt', function () {
        var PageInfo = $('#golongan-table').DataTable().page.info();
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#id').val(data.id);
                $('#n_golongan').val(data.n_golongan).focus();
                $('#ket').val(data.ket);
            },
            error : function() {
    ...
    $('#form').on('submit', function (e) {
        if ($(this)[0].checkValidity() === false) {
            ...
            if (save_method == 'add'){
                ...
                url = "{{ route('golongan.update', ':id') }}".replace(':id', $('#id').val());
            }
            $.ajax({
                url : url,
                type : 'POST',
