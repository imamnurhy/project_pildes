...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "{{ route('pertanyaan.edit', ':id') }}".replace(':id', id),
            type: "GET",
            dataType: "JSON",
            ...
            buttons: {
                ok: {
                    ...
                    action: function(){
                        ...
                        $.ajax({
                            url : "{{ route('pertanyaan.destroy', ':id') }}".replace(':id', id),
                            type : "POST",
    ...
    $('#form').on('submit', function (e) {
        if ($(this)[0].checkValidity() === false) {
            ...
            if (save_method == 'add'){
                ...
                url = "{{ route('pertanyaan.update', ':id') }}".replace(':id', $('#id').val());
            }
            $.ajax({
                url : url,
                type : 'POST',
