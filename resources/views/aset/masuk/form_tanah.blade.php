        ...
        <div class="form-inline row">
            <div class="col-md-6">
                <div class="form-group m-0 col-md-12">
                    ...
                    <input type="text" name="nm_lahan" id="nm_lahan" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" value="{{ $data ? $data->nm_lahan : '' }}" required />
                </div>

                <div class="form-group m-0 col-md-12">
                    <label for="luas" class="col-form-label s-12 col-md-4">Luas</label>
                    <input type="text" name="luas" id="luas" value="{{ $data ? $data->luas : '' }}"  class="form-control light r-0 s-12 col-md-6"
                ...
                <div class="form-group m-0 col-md-12">
                    ...
                    <input type="text" name="alamat" id="alamat" value="{{ $data ? $data->alamat : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required />
                </div>

                <div class="form-group m-0 col-md-12">
                    <label for="batas_barat" class="col-form-label s-12 col-md-4">Batas Barat</label>
                    <input type="text" name="batas_barat" id="batas_barat" value="{{ $data ? $data->batas_barat : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required />
                </div>

                <div class="form-group m-0 col-md-12">
                    <label for="batas_timur" class="col-form-label s-12 col-md-4">Batas Timur</label>
                    <input type="text" name="batas_timur" id="batas_timur" value="{{ $data ? $data->batas_timur : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required />
                </div>
                ...
                <div class="form-group m-0 col-md-12">
                    ...
                    <input type="text" name="batas_selatan" id="batas_selatan"
                        class="form-control light r-0 s-12 col-md-6" autocomplete="off" value="{{ $data ? $data->batas_selatan : '' }}" required />
                </div>

                <div class="form-group m-0 col-md-12">
                    <label for="batas_utara" class="col-form-label s-12 col-md-4">Batas Utara</label>
                    <input type="text" name="batas_utara" id="batas_utara" value="{{ $data ? $data->batas_utara : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required />
                </div>

                <div class="form-group m-0 col-md-12">
                    <label for="latitude" class="col-form-label s-12 col-md-4">Latitude</label>
                    <input type="text" name="latitude" id="latitude" value="{{ $data ? $data->latitude : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required
                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group m-0 col-md-12">
                    ...
                    <input type="text" name="longitude" id="longitude" value="{{ $data ? $data->longitude : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required
                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                </div>
                ...
                <div class="form-group m-0 col-md-12">
                    ...
                    <input type="text" name="luas_tanah" id="luas_tanah" value="{{ $data ? $data->luas_tanah : '' }}" class="form-control light r-0 s-12 col-md-6"
                        autocomplete="off" required
                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                </div>
                ...
                <div class="form-group m-0 col-md-12">
                    ...
                    <a class="col-md-6" target="_blank"   href="{{route('aset.masuk.download_berkas',$data->tanda_bukti) }}">Lihat File</a><br>
                    @endif
        ...
        <div id="kel_ber">
            <div class="form-row">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input type="text" name="no_sertifikat[]" id="no_sertifikat_1" style="height:38px" class="form-control light r-0 s-12 col-md-12"
                    autocomplete="off"  />
                </div>
                <div class="form-group col-md-2">
                    <label for="no" class="col-form-label s-12 col-md-12 pl-0">Nama Pemegang Hak</label>
                    <input type="text" name="nm_pemegang_hak[]" style="height:38px" id="nm_pemegang_hak_1" class="form-control light r-0 s-12 col-md-12"
                    autocomplete="off"  />
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" name="nib[]" id="nib_1" style="height:38px" class="form-control light r-0 s-12 col-md-12"
                    autocomplete="off"  />
                </div>
                ...
                <div class="form-group col-md-1">
                    <label for=""></label>
                    <a class="btn-fab btn-fab-sm shadow btn-primary addBtnFrm"
                        style="" id="addBtn1" onclick="addForm();"><i
                            class="icon-plus"></i></a>
                </div>
            </div>
                ...
                @foreach ($tbl_berkas as $i)
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('aset.masuk.download_berkas',$i->berkas)}}">Download</a></td>
                            <td class="text-center"><a href='#' onclick='remove({{$i->id}})' class='text-danger' title='Hapus Berkas'><i class='icon-remove'></i></a></td>
                    </tr>
