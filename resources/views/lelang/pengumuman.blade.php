    ...
    <header class="blue accent-3 relative nav-sticky">
        <div class="container-fluid text-white">
            <div class="row">
                <div class="col">
                    <h3 class="my-2">
                        <i class="icon icon-bullhorn"></i> Data Pengumuman
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="card no-b">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="pengumuman-table" class="table table-striped" style="width:100%">
                        <thead>
                            <th width="30">No</th>
                            <th>Judul</th>
...
<script type="text/javascript">
    ...
    var table = $('#pengumuman-table').dataTable({
        ...
        columns: [
            ...
            {data: 'n_pengumuman', name: 'n_pengumuman'},
    ...
    table.on('draw.dt', function () {
        var PageInfo = $('#pengumuman-table').DataTable().page.info();
