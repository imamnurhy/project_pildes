...
class ArsipSetujuController extends Controller
{
    ...
    public function api(Request $request)
    {
        ...
        return Datatables::of($tmpelamar)
            ->addColumn('action', function($p){
                return "<a href='".route('arsipSetuju.edit', $p->id)."' title='Tampilan Berkas Lamaran'><i class='icon-file-text-o mr-2'></i></a>";
            })
    ...
    public function edit($id)
    {
        ...
        if(!$tmpelamar || $tmpelamar->tmpelamar_status_id != 3){
            ...
            return view('seleksi.arsipSetuju.edit', compact('tmpelamar', 'trpelamar_syarats', 'n_golongan', 'n_eselon'));
        }
    }
}
